...
namespace PIQI.CustomSAMs
{
    ...
    /// </summary>
    public class SAM_AttrIsNonNumeric : SAMBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SAM_AttrIsNonNumeric"/> class.
        /// </summary>
        /// <param name="sam">The SAM object associated with this evaluator.</param>
        /// /// <param name="samService">
        /// An implementation of <see cref="SAMService"/> used to access reference data and make FHIR API calls.
        /// </param>
        public SAM_AttrIsNonNumeric(SAM sam, SAMService samService) : base(sam, samService) { }
        ...
        public override async Task<PIQISAMResponse> EvaluateAsync(PIQISAMRequest request)
        {
            ...
            try
            {
                ...
                EvaluationItem? evaluationItem = request.EvaluationObject as EvaluationItem;
                MessageModelItem? item = evaluationItem?.MessageItem;

                // Access the attribute's message data
                if (item?.MessageData is BaseText data)
                {
                    // Check if the data is a non-numeric
                    passed = !data.IsFloat() && !data.IsInt();
                }
                else
                {
                    // If it's not text data (like a complex object), it's non-numeric by definition
                    passed = true;
                }
        ...
        /// </summary>
        public static string StaticMnemonic => "ATTR_ISNONNUMERIC";
        /// <summary>
