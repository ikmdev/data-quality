...
function parseArgs(argv) {
    const options = {
        ...
        assessmentTableName: 'piqi_evaluation_results'
    };
...
function printUsage() {
    ...
    console.log('Verifies and creates required PostgreSQL tables if they do not exist.');
    console.log('');
    console.log('Options:');
    ...
    console.log('  --table-name <name>                Evaluation run table name (default: piqi_evaluation_run)');
    console.log('  --assessment-table-name <name>     Assessment results table (default: piqi_evaluation_results)');
    console.log('');
...
(async function main() {
    ...
    try {
        ...
        console.log(`Evaluation Run Table: ${options.tableName}`);
